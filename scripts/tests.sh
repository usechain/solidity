...
function download_aleth()
{
    if [[ "$OSTYPE" == "darwin"* ]]; then
        ...
        ALETH_HASH="7a108efe36eb75db916e5f24b5574cf4b966ffee"
        wget -q -O /tmp/test/aleth.tar.gz https://github.com/ethereum/aleth/releases/download/v1.4.0/aleth-1.4.0-linux-x86_64.tar.gz
